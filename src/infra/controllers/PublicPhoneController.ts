...
export class PublicPhoneController {
  ...
  async create(@Body() body: any, @Req() req: Request) {
    try {
      ...
      logger.info({ module: 'PublicPhones', action: 'createPublicPhone', message: 'Public phone created' });
      return buildResponse({ res: result, success: true, status: 201, path: req.path });
    } catch (error) {
      logger.error({ module: 'PublicPhones', action: 'createPublicPhone', message: 'Error at creating public phone' });
      throw error;
    }
  }
  ...
  async list(@Query('page') page: string, @Query('perPage') perPage: string, @Req() req: Request) {
    try {
      ...
      logger.info({ module: 'PublicPhones', action: 'listPublicPhones', message: 'Public phones listed' });
      return buildResponse({ res: result, success: true, status: 200, path: req.path });
    } catch (error) {
      logger.error({ module: 'PublicPhones', action: 'listPublicPhones', message: 'Error at listing public phones' });
      throw error;
    }
  }
  ...
  async findById(@Param('id') id: string, @Req() req: Request) {
    try {
      ...
      logger.info({ module: 'PublicPhones', action: 'findPublicPhoneById', message: 'Public phone found' });
      return buildResponse({ res: result, success: true, status: 200, path: req.path });
    } catch (error) {
      logger.error({ module: 'PublicPhones', action: 'findPublicPhoneById', message: 'Error at finding public phone' });
      throw error;
    }
  }
  ...
  async update(@Param('id') id: string, @Body() body: any, @Req() req: Request) {
    try {
      ...
      logger.info({ module: 'PublicPhones', action: 'updatePublicPhone', message: 'Public phone updated' });
      return buildResponse({ res: result, success: true, status: 200, path: req.path });
    } catch (error) {
      logger.error({ module: 'PublicPhones', action: 'updatePublicPhone', message: 'Error at updating public phone' });
      throw error;
    }
  }
  ...
  async remove(@Param('id') id: string, @Req() req: Request) {
    try {
      ...
      logger.info({ module: 'PublicPhones', action: 'deletePublicPhone', message: 'Public phone deleted' });
      return buildResponse({ res: null, success: true, status: 200, path: req.path });
    } catch (error) {
      logger.error({ module: 'PublicPhones', action: 'deletePublicPhone', message: 'Error at deleting public phone' });
      throw error;
    }
  }
}
