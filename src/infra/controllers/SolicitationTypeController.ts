...
import {
  createSolicitationTypeSchema,
  updateSolicitationTypeSchema,
} from '../validation/schemas/solicitationTypeSchemas.js';
...
export class SolicitationTypeController {
  ...
  async create(@Body() body: any, @Req() req: Request) {
    try {
      ...
      logger.info({
        ...
        action: 'createSolicitationType',
        message: 'Solicitation type created',
      });
      ...
      logger.error({
        module: 'SolicitationTypes',
        action: 'createSolicitationType',
        message: 'Error at creating solicitation type',
      });
      throw error;
    }
  }
  ...
  async list(
    ...
    try {
      ...
      logger.info({
        ...
        message: 'Solicitation types listed',
      });
      return buildResponse({
        res: result,
        success: true,
      ...
      logger.error({
        module: 'SolicitationTypes',
        action: 'listSolicitationTypes',
        message: 'Error at listing solicitation types',
      });
      throw error;
    }
  }
  ...
  async findById(@Param('id') id: string, @Req() req: Request) {
    try {
      ...
      logger.info({
        module: 'SolicitationTypes',
        action: 'findSolicitationTypeById',
        message: 'Solicitation type found',
      });
      return buildResponse({
        res: result,
        success: true,
      ...
      logger.error({
        module: 'SolicitationTypes',
        action: 'findSolicitationTypeById',
        message: 'Error at finding solicitation type',
      });
      throw error;
    }
  }
  ...
  async update(
    ...
    try {
      ...
      logger.info({
        module: 'SolicitationTypes',
        action: 'updateSolicitationType',
        message: 'Solicitation type updated',
      });
      return buildResponse({
        res: result,
        success: true,
      ...
      logger.error({
        module: 'SolicitationTypes',
        action: 'updateSolicitationType',
        message: 'Error at updating solicitation type',
      });
      throw error;
    }
  }
  ...
  async remove(@Param('id') id: string, @Req() req: Request) {
    try {
      ...
      logger.info({
        module: 'SolicitationTypes',
        action: 'deleteSolicitationType',
        message: 'Solicitation type deleted',
      });
      return buildResponse({
        res: null,
        success: true,
      ...
      logger.error({
        module: 'SolicitationTypes',
        action: 'deleteSolicitationType',
        message: 'Error at deleting solicitation type',
      });
      throw error;
    }
  }
